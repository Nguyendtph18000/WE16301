...
<!-- Mirrored from demo.bosathemes.com/html/travele/admin/db-package-pending.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Nov 2021 08:35:03 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      
      <title>Travele | Tour hết hạn </title>
                            ...
                            <tbody>
                                <?php foreach($tours as $t): ?>
                                    ...
                                    <td>
                                        ...
                                        <td><span class="badge badge-danger"><?php echo $t['status']==0?"Hoạt động":"Hết hạn"; ?></span></td>
                                        <td>
                                            <a href="<?=BASE_URL?>cp-admin/tour-edit&&id=<?=$t['id']?>">
                                                <span class="badge badge-success"><i class="far fa-edit"></i></span>
                                            </a>
                                            <a href="<?=BASE_URL?>cp-admin/tour-expired-delete&&id=<?=$t['id']?>" onclick="return confirm('Xác nhận xóa!')">
